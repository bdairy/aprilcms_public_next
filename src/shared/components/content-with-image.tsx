...
<div
  className={`container image-content ${slicedClass()} ${textPlace()}` }
...
>
  <div className="image">
      ...
      <Image
        className={slicedClass()} width={300} height={300} alt={section.data?.title ?? ''}
  ...
  <div className="content" >
      ...
      {section.data!.link && <Link className="btn-txt primary" href={section.data!.link}  >{section.data!.linkTitle}</Link>}
  </div>
</div>
</div>
);
