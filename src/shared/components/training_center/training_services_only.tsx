...
export default function TrainingServicesOnly(params: { section: ISection; locale: string }) {
  ...
  const checkIfAchievements = () => {
    return url.indexOf('our_achievements') > 0 ? 'acheivements' : '';
  };
  return (
    <motion.div className={`training-services only-services ${checkIfAchievements()}`}>
